\chapter{Testování: Porovnání rychlosti práce s Datastore a testování zátěže}
...
Při prvním testu bylo posláno dohromady 1~000 požadavků se 100 současnými připojeními. Celý test trval 16,656 sekund a po skončení testu bylo na App Engine nahráno 13 akivních instancí.
